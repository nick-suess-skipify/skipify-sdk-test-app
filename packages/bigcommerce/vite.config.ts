...
import { closurify } from '../shared/src/lib/plugins/closurify';

export default defineConfig({
    publicDir: './public',
    plugins: [cssInjectedByJsPlugin(), loadVersion(), closurify({ files: ['bigcommerce.js'] })],
    resolve: {
        alias: {
    ...
    build: {
        ...
        rollupOptions: {
            treeshake: false,
            input: {
                bigcommerce: resolve(__dirname, 'src/index.ts'),
            },
            output: {
